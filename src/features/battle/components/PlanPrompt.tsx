...
import { aliveHeroes, heroById } from '@/systems/battle';
...
export function PlanPrompt({ battle }: PlanPromptProps) {
  ...
  return (
    <div className="relative z-10 mx-3 mt-1.5">
      <div className="flex items-center justify-between rounded-[9px] border border-[rgba(255,200,80,0.3)] bg-[rgba(255,200,80,0.1)] px-2.5 py-1.5">
        <div className="text-[10px] font-bold text-[var(--color-gold)]">{text}</div>
