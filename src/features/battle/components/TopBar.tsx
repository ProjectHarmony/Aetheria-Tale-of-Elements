...
export function TopBar({ battle, onOpenHelp, onOpenItems }: TopBarProps) {
    ...
    <div className="relative z-20 flex items-center justify-between px-3.5 pb-1 pt-4">
      <div className="flex items-center gap-1.5">
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.06 }}
          whileTap={{ scale: 0.94 }}
          className="flex h-[34px] w-[34px] flex-shrink-0 items-center justify-center rounded-full border-2 border-white/25 bg-[#241a30]/90 text-[16px] shadow-[0_4px_12px_rgba(0,0,0,0.3)]"
        >
          🎒
        </motion.button>
      </div>
